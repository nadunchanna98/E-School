...
function StudentRegisterForm() {
  ...
  const formik = useFormik({
    ...
    onSubmit: (data) => {
        ...
        const newData = {
            ...
            Grade: data.Grade,
            Bdate: moment.utc(data.Bdate).format('YY-MM-DD'),
        ...
        axios.post("http://localhost:3001/students/register/",newData).then((response) => {
  ...
  return (
    <div className="Registration-n">
      ...
      <h1 className='Topic-n' >Student Registration</h1>
